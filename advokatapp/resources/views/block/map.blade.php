<section class="section mapContainer">
    ...
    <div id="mapContacts" class="mapContacts">
        ...
        <ul class="ulContacts">
            ...
            <li class="li"><a target="_blank" class="link startphone" href="tel:+380682381383">+38 (068) 238-138-3</a>
            </li>
            <li class="li"><p class="text">E-mail:</p>   <a target="_blank" class="link startemail"
                                                            href="mailto:bestlawyer.kiev@gmail.com">bestlawyer.kiev@gmail.com</a>.
            </li>
        </ul>
        <ul class="callMeSocial">
            ...
            <li>
                ...
                <a target="_blank" class="forPc" title="Viber for PC must be installed"
                   href="viber://chat?number=+380682381383"><img src="{{url::asset('/assets/images/viber.png')}}"></a>
            </li>
        </ul>
        ...
        {{--            </li>--}}
        {{--        </ul>--}}
        <a class="btn btn-black" href="#" data-bs-toggle="modal" data-bs-target="#CallMe">Request a call</a>
    ...
    <script>
        ...
        loadScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyA-IJwfrm4d7LRLRy8mLASjH1b3ewK1NEE&callback=initMap", function () {

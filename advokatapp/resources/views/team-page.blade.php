...
<section class="section team">
    <div class="wrap">
        <div class="block ">
            <div class="photo">
                <img class="layerPhoto" src="{{ URL::asset('/assets/home-slider/Luk\'yanenko-Yaroslav-Volodimirovich.jpg') }}">
            </div>
            <div class="info">
                <div class="title">
...
<div class="modal" tabindex="-1" id="exampleModal11">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title modal-title ">Лук'яненко Ярослав Володимирович.</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text">
                ...
                ◆ договірна робота;<br>
                ◆ податкове право;<br>
                ◆ захист у справах про правопорушення у сфері службової діяльності;<br>
                ◆ земельне право та нерухомість;<br>
                ◆ правова безпека бізнесу;<br>
                ◆ розроблення та впровадження "дорожніх карт" по виходу зі складних ситуацій у бізнес-процесах.<br><br>
                Досвід:<br>
                Діяльність у сфері права з грудня 2003 року, у тому числі:<br>
                ◆ робота в органах прокуратури України;<br>
                ◆ керівництво юридичними службами в підприємствах та установах державного сектору;<br>
                ◆ правовий аудит та супровід діяльності підприємств приватного сектору.<br>
                Адвокатська діяльність з грудня 2006 року.<br><br>
                Освіта:<br>
                Національна юридична академія України імені Ярослава Мудрого (Інститут підготовки кадрів для органів прокуратури України), випуск 2004 року, спеціаліст, спеціальність "Правознавство", диплом з відзнакою.
                    <br><br>Хоббі:

                ◆ Шахи (кандидат в майстри спорту);<br>
                ◆ східні єдиноборства (2-й дан Айкідо Айкікай)<br><br>
                Професійне кредо:<br>
                "Нічого не змінюється, якщо нічого не змінювати"<br><br>
                </p>
            </div>

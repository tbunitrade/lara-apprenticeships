...
<section class="section team">
    <div class="wrap">
        <div class="block ">
            <div class="photo">
                <img class="layerPhoto" src="{{ URL::asset('/assets/home-slider/Bezzubchenko-Larysa-Volodymyrivna.jpg') }}">
            </div>
            <div class="info">
                <div class="title">
                ...
                <div class="details">
                    <p class="text layerDetails">
                        Провідний спеціаліст у галузі господарського, податкового,  корпоративного, цивільного, сімейного, трудового, ...
                    </p>
        ...
        <div class="block ">
            <div class="photo">
                <img class="layerPhoto" src="{{ URL::asset('/assets/home-slider/Shamardin-Volodymyr-Mykolayovych.jpg') }}">
            </div>
            <div class="info">
                <div class="title">
                    <p class="text layerName">
                ...
                <div class="details">
                    <p class="text layerDetails">
                        Великий досвід по захисту громадян у кримінальних та адміністративних справах, в тому числі осіб, які займали керівні посади на великих промислових підприємствах...
                    </p>
        ...
        <div class="block " style="display:none;">
            ...
            <div class="info">
                ...
                <div class="details">
                    ...
                    <button type="button" class="btn btn-primary btn-about-lawyer" data-bs-toggle="modal" data-bs-target="#exampleModal16">
                        Додаткова інформація
                    </button>
                </div>
            </div>
        ...
        <div class="block ">
            <div class="photo">
                <img class="layerPhoto" src="{{ URL::asset('/assets/home-slider/Xarchenko-Oksana-Oleksiïvna.jpg') }}">
            </div>
            <div class="info">
                <div class="title">
                    <p class="text layerName">
                ...
                <div class="details">
                    <p class="text layerDetails">
                        Використовує індивідуальний підхід до кожного клієнта, а також творчий підхід до судових розглядів і завжди досягає найкращих результатів...
                    </p>
...
<div class="modal" tabindex="-1" id="exampleModal11">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title modal-title ">Беззубченко Лариса Володимирівна.</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text">
                    Адвокат провідний спеціаліст у галузі господарського, податкового,  корпоративного, цивільного, сімейного, трудового, спадкового права, судового захисту прав власності.
                    <br><br>
                    Освіта: Національна юридична академія України ім. Ярослава Мудрого, спеціальність – правознавство. Спеціаліст – юрист (1995). Диплом з відзнакою; Приазовський державний технічний університет, спеціальність – фінанси та кредит. Фахівець у галузі економіки та підприємництва за напрямом фінанси (2003).
                    <br><br>
                Досвід роботи:<br>
                1995 – 1996 – юрисконсульт ТОВ «Фантом» (Маріуполь).<br>
                1996 – 2011 – юрисконсульт ЗАТ «Азовзовніштранс» (Маріуполь).<br>
                З грудня 2011 року – провідний юрисконсульт ТОВ «ЮК «Юристократ».<br>
                З серпня 2013  – начальник Департаменту правового захисту ТОВ "ЮК "Юристократ".<br>
                З вересня 2013  – адвокат ТОВ "ЮК "Юристократ".<br>
                З січня 2023  – адвокат Колегії адвокатів міста Києва та Київської області<br>
                    <br><br>
                Практики: господарський та цивільний процес; експортно-імпортні операції; захист прав власності; корпоративне право; сімейне право; трудове право; спадкове право; митне право; судова практика.
                </p>
            </div>
...
<div class="modal" tabindex="-1" id="exampleModal15">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title modal-title">Шамардін Володимир Миколайович.</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text">
                    Адвокат
                    <br><br>
                    Освіта: Національна юридична академія України ім. Ярослава Мудрого (м. Харків).<br><br>
                    Досвід роботи:<br>
                    1988 -1991р.р.    юрисконсульт завод «Вторчормет».<br>
                    1991-2023р.р.    Адвокат Юридичної консультації міста, а згодом - Колегії адвокатів міста Києва  та Київської області. Адвокатський стаж 32 роки, а загальний юридичний - 35 років.
                    <br><br>
                    Великий досвід по захисту громадян у кримінальних та адміністративних справах, в тому числі осіб, які займали керівні посади на великих промислових підприємствах.
                    <br><br>
                    Практики: надання юридичних консультацій, складання заяв, позовних заяв, апеляційних, касаційних скарг, а також звернення зі скаргами до Європейського Суду з прав людини.
                    <br><br>
                    Представництво інтересів громадян в усіх державних органах,  приватних і громадських організаціях.
                    <br><br>
                    Успішний досвід надання юридичних послуг та супроводу клієнтів у цивільних, сімейних, трудових, спадкових, пенсійних справах у судах першої, апеляційної та касаційної інстанцій.
                </p>
            </div>
        </div>
    </div>
...
<div class="modal" tabindex="-1" id="exampleModal17">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title modal-title"> Харченко Оксана Олексіївна.</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text">
                    Адвокат надає широкий спектр професійної юридичної допомоги громадянам і бізнесу.
                    Має багато листів подяки від клієнтів.
                    Використовує індивідуальний підхід до кожного клієнта, а також творчий підхід до судових розглядів і завжди досягає найкращих результатів.
                    <br><br>
                    Має досвід та спеціалізацію в галузях: господарського, цивільного, корпоративного, спадкового, сімейного, податкового, трудового, житлового, земельного права.
                    <br><br>
                    Навчалась і отримала вищу юридичну освіту у Київській Міжрегіональній Академії управління персоналом у 2005 році: економіко-правовий факультет, кваліфікація – юрист (диплом спеціаліста з відзнакою). З 2011 року почала займатися приватною юридичною практикою - робота була  плідно пов'язана з підприємствами різних сфер діяльності та підприємцями, а також з фізичними особами з питань юридичного характеру: державна реєстрація юридичних осіб та ФОП, реєстрація змін установчих документів, консультації, правовий аналіз та складання договорів, допомога в оформленні та одержанні різних дозвільних документів, необхідних для господарської діяльності підприємств та підприємців, досудова та судова робота, складання процесуальних документів (позовні заяви, клопотання, відзиви, заперечення, апеляційні та касаційні скарги та ін.), представництво і захист у судах та інших державних органах, операції з землею та нерухомістю (узаконювання, приватизація) та багато інших питань.
                    <br><br>
                    У 2019 році отримала свідоцтво про право на заняття адвокатською діяльністю.
                    <br><br>
                    З 2006 року займала посади юрисконсульта у компаніях різного роду господарської діяльності: «Українська універсальна товарна біржа», ТОВ «Агентство безпеки»,                        ТОВ «Компас».
                    <br><br>
                    З 2019 року займала посади керівника юридичного відділу у ТОВ «ЕТС»,                                   ПрАТ «Донецькоблгаз», ТОВ «СІ ЕС ДІ ЛАБ».

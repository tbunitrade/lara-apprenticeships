    ...
    <div class="wrap">
        ...
        <div class="block ">
            ...
            <div class="info">
                ...
                <div class="details">
                    <p class="text layerDetails">
                        Адвокат сімейної, цивільної, корпоративної практики з досвідом роботи в сфері юриспруденції понад 6 років...
                    </p>
...
<div class="modal" tabindex="-1" id="exampleModal17">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title modal-title">Трохимцук Діана Володимирівна.</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text">
                    Адвокат сімейної, цивільної, корпоративної практики з досвідом роботи в сфері юриспруденції понад 6 років.
                     <br><br>
                    Мета професійної діяльності – допомогти своїм клієнтам знайти рішення щодо юридичних питань, які можуть виникнути у житті кожної людини:
                    <br><br>
                    <strong>у сфері сімейного права</strong>: поділ майна, визначення місця проживання дітей, усунення перешкод у спілкуванні з дітьми, стягнення аліментів , збільшення/зменшення розміру аліментів, позбавлення/поновлення батьківських прав, в тому числі вирішення спорів за участю іноземців.
                    <br><br>
                    <strong>у  цивільних судових справах</strong>: встановлення фактів, що мають юридичне значення, визнання недійсними правочинів, стягнення боргів, виселення колишнього члена сім’ї, визнання права власності на нерухомість, тощо.
                    <br><br>
                    <strong>юридичний супровід бізнесу</strong>: реєстрація/ліквідація ФОП та ТОВ, написання договорів, внесення змін до установчих документів, подання звітностей, розблокування податкових накладних, отримання ліцензій та дозволів.
                    <br><br>
                    <strong>супровід виконавчого провадження</strong> як на стороні стягувачів, так і на стороні платників та боржників;
                    <br><br>
                    <strong>отримання дублікатів документів</strong>: свідоцтва актів цивільного стану, рішення суду, тощо;
                    <br><br>
                    <br><br>
                    У своїй роботі дотримується високих стандартів професійної етики та забезпечує конфіденційність інформації, отриманої від клієнтів.
                    <br><br>
                </p>
            </div>
        </div>

...
<form id="consultationForm" class="consultationForm" method="post" action="{{url('store-form')}}">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <input name="number" id="clientPhone" class="input" type="number" placeholder="Номер телефону" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="19" required>
